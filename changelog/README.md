...
[Profile and identity](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/taimi/profile-and-identity) is
...
[experiment page](https://appflame.gitbook.io/appflame-knowledge-base/experiments/active/exp-2026-121-taimi-onboarding-length).
{% endupdate %}
...
| Experiments only in Jira | [Experiments](https://appflame.gitbook.io/appflame-knowledge-base/experiments/) space |
...
in the [Lifecycle campaigns](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/mailkeeper/lifecycle-campaigns)
configuration table.
...
[dashboards](https://appflame.gitbook.io/appflame-knowledge-base/analytics/reporting/dashboards).
{% endupdate %}
...
[Matching and discovery](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/hily/matching-and-discovery).

[Readout](https://appflame.gitbook.io/appflame-knowledge-base/experiments/concluded/exp-2026-098-hily-match-queue-ranking)
{% endupdate %}
...
[Onboarding flow](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/hily/onboarding-flow)
{% endupdate %}
...
[Profile and identity](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/taimi/profile-and-identity).
{% endupdate %}
