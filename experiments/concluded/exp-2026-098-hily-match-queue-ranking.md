...
- [x] Spec updated — [Matching and discovery](https://appflame.gitbook.io/appflame-knowledge-base/product-specs/hily/matching-and-discovery), `disc_inactive_cutoff_hours` now `72`
